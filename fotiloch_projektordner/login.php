...
require_once('fotiloch_system/fotiloch_data.php');
require_once('fotiloch_system/fotiloch_security.php');
  ...
  $db = get_db_connection();
      $sql = "INSERT INTO user (email, password) VALUES ('$email', '$password');";
       if(mysqli_query($db, $sql)){
        ...
        $success_msg .= "Bitte loggen Sie sich ein.<br/>";
      }else{
        $error = true;
    ...
    <div class="container">
    	<div class="row">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-6">
                <input type="submit" name="login-submit" id="login-submit" tabindex="4" class="form-control btn btn-login" value="anmelden">
              </div>
            </div>
          </div>
        </form>
